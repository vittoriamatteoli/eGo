...
const GlobalStyle = createGlobalStyle`
  :root {
    ...
    --ego-gradient-cutoff-dt: linear-gradient(90deg, rgba(204,224,161,1) 0%,rgba(220,222,208,1) 40%, #fefff9 0%);
   --ego-gradient-cutoff-mob: linear-gradient(180deg, rgba(204,224,161,1) 0%,rgba(220,222,208,1) 40%, #fefff9 0%);
  }
